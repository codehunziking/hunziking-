    ...
    public Connection getConn() {
        try {
            if (conn == null || conn.isClosed()) {
			        	 ...
			        	 conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jspm04274dzswwz?useUnicode=true&characterEncoding=UTF-8&useOldAliasMetadataBehavior=true&autoReconnect=true","root","admin");
			        	 // mysql 8.0 以上使用
			        	 //Class.forName("com.mysql.cj.jdbc.Driver"); 
			        	 //conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jspm04274dzswwz?useUnicode=true&characterEncoding=UTF-8&useSSL=FALSE&serverTimezone=UTC&useOldAliasMetadataBehavior=true&autoReconnect=true","root","root");
