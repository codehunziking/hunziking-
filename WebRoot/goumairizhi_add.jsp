...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="goumairizhi.jsp?a=insert" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:250px;" id="shangpin" name="shangpin" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="number" class="form-control" style="width:150px;" step="0.01" number="true" data-msg-number="输入一个有效数字" id="xiaoji" name="xiaoji" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
