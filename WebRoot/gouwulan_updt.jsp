...
<%
    ...
    HashMap mmm = new CommDAO().getmap(request.getParameter("id") , "gouwulan");
    %>
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="gouwulan.jsp?a=update" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <% 
 HashMap mapfenlei10 = new CommDAO().find("SELECT fenleimingcheng FROM fenlei where id='"+mmm.get("fenlei")+"'"); 
 %><%= mapfenlei10.get("fenleimingcheng") %><input type="hidden" id="fenlei" name="fenlei" value="<%= Info.html(mmm.get("fenlei")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
...
<script>
    $(function(){
        var strings = "<%= mmm.get("guige") %>".split(",");
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="number" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写购买数量" number="true" data-msg-number="输入一个有效数字" id="goumaishuliang" name="goumaishuliang" value="<%= Info.html(mmm.get("goumaishuliang")) %>"/>                                            
        </div>
    </div>
</div>
                                                                            <div class="form-group">
