...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
        ...
        if (request.getParameter("shoujianren") != null && !"".equals(request.getParameter("shoujianren"))) {
            where += " AND shoujianren LIKE '%" + request.getParameter("shoujianren") + "%'";
        }
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="" name="shoujianren"
                               value="<%= request.getParameter("shoujianren") !=null ? request.getParameter("shoujianren") : "" %>"/>
                    </div>
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%= map.get("shoujianren") %>
                        </td>
                        <td><%= map.get("fajianren") %>
                        </td>
                        ...
                        <td align="center">
                            ...
                            <a href="dianziyoujian.jsp?a=delete&id=<%= map.get("id") %>"
