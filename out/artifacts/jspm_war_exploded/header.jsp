                ...
                <div class="header-top-inner">
                    <div class="cnt-account">
                        <ul class="list-unstyled">
                            ...
                            <li><a href="logout.jsp" onclick="return confirm('确定退出？')"><i class="icon fa fa-sign-out"></i>退出</a></li>
                            <% } else { %>
                            <li><a href="#" data-toggle="modal" data-target="#loginModel"><i class="icon fa fa-lock"></i>用户登录</a></li>
                                                        <% } %>
                        </ul>
                    </div>
                    <!-- /.cnt-account -->
            ...
            <div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
                ...
                <div class="row" gutter="20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 logo-holder">
                        ...
                        <!-- ============================================================= LOGO ============================================================= -->
                        <div class="logo"><a href="./"> 电子商务网站 </a></div>
                        <!-- /.logo -->
                        <!-- ============================================================= LOGO : END ============================================================= -->
...
<ul class="nav-child">
                    <% 
 List<HashMap> mapfenlei1 = new CommDAO().select("SELECT id,fenleimingcheng FROM fenlei"); 
 %>
<%  for(HashMap m:mapfenlei1){  %>
<li><a href="shangpinxinxilist.jsp?fenlei=<%= m.get("id") %>"><%= m.get("fenleimingcheng") %></a></li>
<% } %>
</ul>
</li>
<li>
<a href="liuyanbanadd.jsp">反馈留言
</a>
</li>
<li>
<a href="yonghuadd.jsp">用户注册
</a>
</li>
<li>
<a href="login.jsp">后台登录
</a>
</li>                    </ul>
                </div>
