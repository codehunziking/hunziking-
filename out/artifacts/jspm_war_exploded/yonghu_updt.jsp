...
$(".class_xingbie4").val($(".class_xingbie4").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写邮箱" remote="factory/checkno.jsp?checktype=update&id=<%= mmm.get("id") %>&table=yonghu&col=youxiang" data-msg-remote="内容重复了" email="true" data-msg-email="请输入有效邮件地址" id="youxiang" name="youxiang" value="<%= Info.html(mmm.get("youxiang")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
