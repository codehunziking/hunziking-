...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_pingjia13" data-value="<%= Info.html(mmm.get("pingjia")) %>" id="pingjia" name="pingjia" style="width:250px">
...
<script>
$(".class_pingjia13").val($(".class_pingjia13").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="qianshouren" name="qianshouren" value="<%= mmm.get("qianshouren") %>"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
