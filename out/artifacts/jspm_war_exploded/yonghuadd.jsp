...
<option value="女">女</option>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写邮箱" remote="factory/checkno.jsp?checktype=insert&table=yonghu&col=youxiang" data-msg-remote="内容重复了" email="true" data-msg-email="请输入有效邮件地址" id="youxiang" name="youxiang" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
