...
where+=" AND xingbie ='"+request.getParameter("xingbie")+"'"; } 
                 ...
                 if(request.getParameter("youxiang") != null && !"".equals( request.getParameter("youxiang") )){ where+=" AND youxiang LIKE '%"+request.getParameter("youxiang")+"%'"; } 
...
$(".class_xingbie1").val($(".class_xingbie1").attr("data-value"))</script>
    ...
    邮箱
                            ...
                            <input type="text" class="form-control" style="" name="youxiang" value="<%= request.getParameter("youxiang") !=null ? request.getParameter("youxiang") : "" %>"/>                        
</div>
                                                                <div class="form-group">
    身份证
...
<td> <% if( "".equals( map.get("touxiang") ) ){ %>-<% } else { %><img width="100" src="<%= map.get("touxiang") %>"/><% } %> </td>
                        ...
                        <td align="center">
                                                                                    ...
                                                                                    <a href="yonghu_updt.jsp?id=<%= map.get("id") %>">修改</a>
                            <a href="yonghu.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a>
                            <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>
