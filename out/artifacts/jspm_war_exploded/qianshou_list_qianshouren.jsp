...
<div style="padding: 10px">
    <%
        ...
        where += " AND qianshouren='" + request.getSession().getAttribute("username") + "' "; //  设置qianshouren为当前登录用户
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td align="center">
                            ...
                            <a href="qianshou_updt.jsp?id=<%= map.get("id") %>">修改</a>
                            <a href="qianshou.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a>
                            <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>
